public class OperadorInstanceOfTiposGenericos {
    public static void main(String[] args) {
        //El Object sigue siendo un String pero esta asociado el tipo generico
        Object texto = "Creando un objeto de la clase String .. que tal!";

        //Estancia de referencias al usar las clases(como lo es Integer,Long, etc..) de los primitivos
        //Number num = 7;

        //Nota: la manera correcta de crea una instancia es:
        ...
        //Es una instancia de los primitivos
